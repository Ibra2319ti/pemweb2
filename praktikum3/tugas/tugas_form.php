    ...
    <div class="container p-4">
        ...
        if (isset($_POST['nim'])) { 
            ...
            if (isset($_POST['skill'])) {
                foreach ($skills as $skillz) {
                    if (isset($skill[$skillz])) {
                        $point += $skill[$skillz];
                    }
                }
            }
            ...
            if ($point == 0) {
                ...
                $predikat = "Baik";
            } elseif ($point > 100 && $point <= 150) {
                $predikat = "Sangat Baik";
            } elseif ($point > 150 && $point <= 190) {
                $predikat = "Superior";
            }
        ?>
            <table class="table">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <?php foreach ($skills as $skillskey => $skillsvalue) { ?>
                            <input type="checkbox" name="skills" id="<?= $skillskey ?>" value="<?= $skillskey ?>">
